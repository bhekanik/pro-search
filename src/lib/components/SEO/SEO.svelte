...
<svelte:head>
	...
	<meta property="og:url" content={`${protocol}//${host}${pathname}`} />
	<meta property="og:image" content={`${protocol}//${host}${pathname}OG.png`} />
	...
	<meta name="twitter:image" content={`${protocol}//${host}${pathname}OG.png`} />
