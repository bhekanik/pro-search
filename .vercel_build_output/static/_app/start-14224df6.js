...
function Rt(n) {
	...
	return {
		...
		l(c) {
			t && V(t.$$.fragment, c), (e = bt(c)), l && l.l(c), (s = w());
		},
		m(c, u) {
		...
		o(c) {
			t && b(t.$$.fragment, c), (r = !1);
		},
		d(c) {
			t && L(t, c), c && y(e), l && l.d(c), c && y(s);
		}
	};
}
function St(n, t, e) {
...
const Lt = 'modulepreload',
	...
	j = [
		() =>
			J(
				() => import('./pages/__layout.svelte-1d49a325.js'),
				[
					'pages/__layout.svelte-1d49a325.js',
					'assets/pages/__layout.svelte-e8858dce.css',
					'chunks/vendor-12abbdca.js'
				]
			),
		() =>
			J(
				() => import('./error.svelte-08606be3.js'),
				['error.svelte-08606be3.js', 'chunks/vendor-12abbdca.js']
			),
		() =>
			J(
				() => import('./pages/index.svelte-b0857921.js'),
				['pages/index.svelte-b0857921.js', 'chunks/vendor-12abbdca.js']
			)
	],
	At = [[/^\/$/, [j[0], j[2]], [j[1]]]],
	Nt = [j[0](), j[1]()];
